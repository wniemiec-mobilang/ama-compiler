...
class AssignmentExpressionJsonParserTest {

    //-------------------------------------------------------------------------
    //		Attributes
    //-------------------------------------------------------------------------
    private AssignmentExpressionJsonParser parser;
    ...
    @BeforeEach
    void setUp() {
        parser = AssignmentExpressionJsonParser.getInstance();
    ...
    private void doParsing() throws ParseException, IOException {
        parsedExpression = parser.parse(buildAssignmentExpression());
    }

    private JSONObject buildAssignmentExpression() {
        JSONObject expression = new JSONObject();

        expression.put("type", "AssignmentExpression");

...
class AssignmentPatternExpressionJsonParserTest {
    
    //-------------------------------------------------------------------------
    //		Attributes
    //-------------------------------------------------------------------------
    private AssignmentPatternExpressionJsonParser parser;
    ...
    @BeforeEach
    void setUp() {
        parser = AssignmentPatternExpressionJsonParser.getInstance();
    ...
    //-------------------------------------------------------------------------
    @Test
    void testParseWithLeftAndRight() throws ParseException, IOException {
    ...
    private void doParsing() throws ParseException, IOException {
        parsedExpression = parser.parse(buildAssignmentPatternExpression());
    }

    private JSONObject buildAssignmentPatternExpression() {
        JSONObject expression = new JSONObject();

        expression.put("type", "AssignmentPatternExpression");

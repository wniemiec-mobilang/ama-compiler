...
class UpdateExpressionJsonParserTest {
    
    //-------------------------------------------------------------------------
    //		Attributes
    //-------------------------------------------------------------------------
    private UpdateExpressionJsonParser parser;
    ...
    @BeforeEach
    void setUp() {
        parser = UpdateExpressionJsonParser.getInstance();
    ...
    @Test
    void testParseWithOperatorAndArgument() 
    throws ParseException, IOException {
        withOperator("++");
        withArgument(buildIdentifier("i"));
        doParsing();
